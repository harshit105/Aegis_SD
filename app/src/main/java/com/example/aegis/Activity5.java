...
public class Activity5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Activity5").child(uID);
    ...
    private void customdialog() {
        AlertDialog.Builder mydialog = new AlertDialog.Builder(Activity5.this);
        LayoutInflater Inflater = LayoutInflater.from(Activity5.this);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Activity5.this, "Item added to your list", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
    ...
    public void updateData() {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabase.child(id).setValue(data);
                Toast.makeText(Activity5.this, "Item updated", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Activity5.this, "Item deleted", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        dialog.show();
